...
const Submit = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Note: This is a placeholder - in production you would send this to your backend
      // For now, just redirect to upload page for actual file upload
      toast.success("Please proceed to upload your film files");
      navigate('/upload');
    } catch (error) {
